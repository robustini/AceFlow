(function () {
  ...
  const I18N = {
    en: {
      ...
      'help.infer_method_dynamic.ode': 'Deterministic Euler baseline. Fastest and most predictable. Same seed tends to stay closer to the same trajectory.',
      'help.infer_method_dynamic.sde': 'Stochastic diffusion path. Re-injects noise during sampling, often giving more variation but less strict repeatability.',
      'help.infer_method_dynamic.midpoint': 'Second-order midpoint solver. Uses an intermediate evaluation to smooth the update. Slower than ODE, usually steadier.',
      'help.infer_method_dynamic.heun': 'Second-order predictor-corrector solver. Tries to correct the first estimate before the final step. Often stable and controlled.',
      'help.infer_method_dynamic.rk4': 'Classical fourth-order Runge-Kutta. Most expensive among these options, with multiple evaluations per step for a more accurate trajectory.',
      'help.infer_method_dynamic.dpm_pp_2m': 'Second-order multistep DPM++ style solver. After the first step it reuses past velocity information, often giving a good quality/speed balance.',
    ...
    it: {
      ...
      'help.infer_method_dynamic.ode': 'Baseline Euler deterministico. Più rapido e prevedibile. A parità di seed tende a restare più vicino alla stessa traiettoria.',
      'help.infer_method_dynamic.sde': 'Percorso diffusivo stocastico. Reintroduce rumore durante il sampling, spesso con più variazione ma meno ripetibilità stretta.',
      'help.infer_method_dynamic.midpoint': 'Solver midpoint del secondo ordine. Usa una valutazione intermedia per rendere l\'aggiornamento più regolare. Più lento di ODE, di solito più stabile.',
      'help.infer_method_dynamic.heun': 'Solver predictor-corrector del secondo ordine. Prova a correggere la prima stima prima del passo finale. Spesso stabile e controllato.',
      'help.infer_method_dynamic.rk4': 'Runge-Kutta classico del quarto ordine. È il più costoso tra queste opzioni, con più valutazioni per passo per una traiettoria più accurata.',
      'help.infer_method_dynamic.dpm_pp_2m': 'Solver multistep del secondo ordine in stile DPM++. Dopo il primo passo riusa l\'informazione di velocità precedente, spesso con un buon equilibrio tra qualità e velocità.',
